...
/* directory provider service is intended to walk a directory and look for modules and components and
 ( at some point ) provide a reference to the data of said modules or components.
*/
@Injectable({
    providedIn: 'root'
})
